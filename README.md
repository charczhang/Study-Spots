...
__Project Role__: Scrum Master: I led a 5-person team as Scrum Master, ensuring team adherence to sprint deadlines, coordinating meetings to discuss design & implementation decisions, and serving as the liaison with teaching staff. I contributed to the development and enhancement of key functionalities, focusing on the implemnetation of Google Login and Maps APIs, our study spot submission form which included use of the Maps API, and Bootstrap styling of the overall website.
